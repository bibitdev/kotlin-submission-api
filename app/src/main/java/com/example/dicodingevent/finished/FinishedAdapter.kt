...
class FinishedAdapter(private var events: List<ListEventsItem?>?) : RecyclerView.Adapter<FinishedAdapter.EventViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_event_finished, parent, false)
